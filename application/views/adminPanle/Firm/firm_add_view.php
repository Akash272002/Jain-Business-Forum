        ...
        <div class="col-md-12">
          ...
          <span class="text-white">Firm Type</span></span>
            ...
            <div class="ms-panel-body">
              ...
              <form class="needs-validation" id="Form" action="<?php echo base_url('Admin/Add_firm/add'); ?>" method="post" autocomplete="off">
                <input name="businesstypeId" id="businesstypeId" value="" type="hidden"> 
                <div class="form-row">
                
                  <div class="col-md-4 ">
                    <label for="name">Firm Type Name <span class="required" style="color: red">*</span></label>
                    <div class="input-group">
                      <input type="text" class="form-control form-control-sm" name="businesstypeName" id="businesstypeName" placeholder="Business Name" autofocus="autofocus" value="" required="">
...
function saveperform()
{
    ...
    else
    {
      ...
      var formData = new FormData(form[0]);
            ...
            $.ajax({
        url:base_path+"Admin/update_firmType/update",
        type: "POST",
        ...
        success: function(data) { 
           ...
           window.location.href = base_path+"Admin/Add_firm/add";
    ...
    {      
         // alert('Insert');
        $.ajax({
              url:base_path+"Admin/Add_firm/insertFimTypes",
              type: "POST",
              data: $('#Form').serialize(),
              beforeSend: function(){
              $('#btn_savee').prop('disabled', true);
