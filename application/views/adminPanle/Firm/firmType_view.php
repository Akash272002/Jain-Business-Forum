        ...
        <div class="col-md-12">
            ...
            justify-content: space-between; border-bottom: 2px solid rgba(227 149 38) !important;">
                    <label class="invoiceInfo  text-center d-block" style="margin: 0 auto;">
                        <span class="common_heading " style="width: auto!important;margin:0 auto;">
                            <span class="text-white">Firm Type Details</span></span>
                    </label>
                ...
                <div class="ms-panel-body">
                    <div class="main_row">
                        ...
                        <a id="create" href="<?php echo base_url('Admin/Add_firm/add'); ?>"
          ...
          <thead>
                                        ...
                                        <?php 
                                            ...
                                            echo '<td class="sorting_1"><a href="' . base_url("Admin/update_firmType/update/" . $value->businesstypeId ) . '"><i class="fas fa-eye" style="font-size: 15px;"></i></a>
                                              </td>';
                                            echo "<td>".$value->businesstypeId ."</td>";
                                            echo "<td>".$value->businesstypeName."</td>";
                                            echo "</tr>";                        
                                        }
                                        ?> 
...
$(document).ready(function() {
    ...
    var table = $('#keyskill_detailview').DataTable({
        ...
        buttons: [
            ...
            {
                extend: 'print',
                title: 'Sole Proprietorship Businesses  report ',
                exportOptions: {
                    modifier: {
