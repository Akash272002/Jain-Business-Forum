            ...
            justify-content: space-between; border-bottom: 2px solid rgba(227 149 38) !important;">
                    <label class="invoiceInfo  text-center d-block" style="margin: 0 auto;">
                        <span class="common_heading " style="width: auto!important;margin:0 auto;">
                            <span class="text-white">Keyskill Details</span></span>
                    </label>
                ...
                <div class="ms-panel-body">
                    ...
                    <div class="icon">
                        ...
                        <a id="create" href="<?= base_url('Admin/Keyskill/Add') ?>"
                        ...
                        <table id="keyskill_detailview" class="table table-bordered table-striped thead-primary w-100">
                            ...
                            <tbody>
                                ...
                                <?php 
                                            ...
                                            echo '<td class="sorting_1"><a href="' . base_url("Admin/KeySkill_update/update/" . $value->keyId) . '"><i class="fas fa-eye" style="font-size: 15px;"></i></a>
                                              </td>';
                                            echo "<td>".$value->keyId."</td>";
                                            echo "<td>".$value->keyName."</td>";
                                            echo "</tr>";                        
                                        }
                                        ?>
