...
<div class="ms-content-wrapper"> 
      <div class="row">
        <div class="col-md-12">
          ...
          <span class="text-white">Keyskill</span></span>
          </label>
            ...
            <div class="ms-panel-body">
              ...
              <form class="needs-validation" id="Form" action="<?php echo base_url('Admin/Keyskill/Add'); ?>" method="post" autocomplete="off">
              <input name="keyId" id="keyId" value="" type="hidden">
                <div class="form-row">
                
                  <div class="col-md-4 ">
                    <label for="name">Keyskill Name <span class="required" style="color: red">*</span></label>
                    <div class="input-group">
                      <input type="text" class="form-control form-control-sm" name="keyName" id="keyName" placeholder="Keyskill Name" autofocus="autofocus" value="" required="">
                ...
                <div style="text-align: end;">
                  ...
                  <a id="create" href="<?php echo base_url('Admin/KeySkill_Detail/index'); ?>" class="Edit btn samplebtn waves-effect waves-light"><i class="fa fa-edit" aria-hidden="true"></i>Edit</a>
                </div>
...
<!-- <script src="<?=base_url()?>Assets/js/AdminJS/keyskillCreate.js"></script> -->
