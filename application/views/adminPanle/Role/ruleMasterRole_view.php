        ...
        <div class="col-md-12">
          ...
          <span class="text-white">Role</span></span>
            ...
            <div class="ms-panel-body">
              ...
              <form class="needs-validation" id="Form" action="<?php echo base_url('Admin/Rulemaster/role'); ?>" method="post" autocomplete="off">
                ...
                <div class="form-row">
                  ...
                  <div class="col-md-4 ">
                    ...
                    <div class="input-group">
                      <input type="text" class="form-control form-control-sm" name="roleName" id="roleName" placeholder="Role Name" autofocus="autofocus" value="" required="">
...
function saveperform()
{
    ...
    else
    {
      ...
      var formData = new FormData(form[0]);
            ...
            $.ajax({
        url:base_path+"Admin/roleUpdate/update",
        type: "POST",
        ...
        success: function(data) { 
           ...
           window.location.href = base_path+"Admin/Rulemaster/role";
    ...
    {      
         // alert('Insert');
        $.ajax({
              url:base_path+"Admin/Rulemaster/insertruleMaster",
              type: "POST",
              data: $('#Form').serialize(),
              beforeSend: function(){
              $('#btn_savee').prop('disabled', true);
