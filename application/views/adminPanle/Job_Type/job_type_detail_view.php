        ...
        <div class="col-md-12">
            ...
            justify-content: space-between; border-bottom: 2px solid rgba(227 149 38) !important;">
                    <label class="invoiceInfo  text-center d-block" style="margin: 0 auto;">
                        <span class="common_heading " style="width: auto!important;margin:0 auto;">
                            <span class="text-white">Jobtype Details</span></span>
                    </label>
                ...
                <div class="ms-panel-body">
                    ...
                    <div class="icon">
                        ...
                        <a id="create" href="<?php echo base_url('Admin/JobType/add'); ?>"
          ...
          <thead>
                                        ...
                                        <?php 
                                            ...
                                            echo '<td class="sorting_1"><a href="' . base_url("Admin/JobType_update/update/" . $value->jobtypeId) . '"><i class="fas fa-eye" style="font-size: 15px;"></i></a>
                                              </td>';
                                            echo "<td>".$value->jobtypeId."</td>";
                                            echo "<td>".$value->jobtypeName."</td>";
                                            echo "</tr>";                        
                                        }
                                        ?> 
