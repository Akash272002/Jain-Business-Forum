<link rel="stylesheet" type="text/css" href="https://www.adminjainbusiness.padmamanisilver.com/assets/css/datatables.min.css">
<link rel="stylesheet" type="text/css" href="https://www.adminjainbusiness.padmamanisilver.com/assets2/detailview.css">
<style>
main.body-content {
        ...
        <div class="col-md-12">
            ...
            justify-content: space-between; border-bottom: 2px solid rgba(227 149 38) !important;">
                    <label class="invoiceInfo  text-center d-block" style="margin: 0 auto;">
                        <span class="common_heading " style="width: auto!important;margin:0 auto;">
                            <span class="text-white">Firm Rule Details</span></span>
                    </label>
                ...
                <div class="ms-panel-body">
                    ...
                    <div class="icon">
                        ...
                        <a id="create" href="<?php echo base_url('Admin/Firmrule/Add');  ?>"
          ...
          <thead>
                                        ...
                                        <?php 
                                            ...
                                            echo '<td class="sorting_1"><a href="' . base_url("Admin/firmRule_update/update/" . $value->ruleId) . '"><i class="fas fa-eye" style="font-size: 15px;"></i></a>
                                              </td>';
                                            echo "<td>".$value->ruleId."</td>";
                                            echo "<td>".$value->businessRule."</td>";
                                            echo "</tr>";                        
                                        }
                                        ?> 
