        ...
        <div class="col-md-12">
          ...
          <span class="text-white">Firm Rule</span></span>
            ...
            <div class="ms-panel-body">
              ...
              <form class="needs-validation" id="Form" action="<?php echo base_url('Admin/Firmrule/Add'); ?>" method="post" autocomplete="off">
                ...
                <div class="form-row">
                  ...
                  <div class="col-md-4 ">
                    ...
                    <div class="input-group">
                      <input type="text" class="form-control form-control-sm" name="businessRule" id="businessRule" autofocus="autofocus" value="" required="">
...
function saveperform()
{
    ...
    else
    {
      ...
      var formData = new FormData(form[0]);
            ...
            $.ajax({
        url:base_path+"Admin/firmRule_update/update",
        type: "POST",
        ...
        success: function(data) { 
           ...
           window.location.href = base_path+"Admin/Firmrule/Add";
    ...
    {      
         // alert('Insert');
        $.ajax({
              url:base_path+"Admin/Firmrule/insertFimRule",
              type: "POST",
              data: $('#Form').serialize(),
              beforeSend: function(){
              $('#btn_savee').prop('disabled', true);
