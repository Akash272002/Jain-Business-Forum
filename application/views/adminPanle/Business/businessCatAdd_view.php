...
<div class="ms-content-wrapper">
    <div class="row">
        <div class="col-md-12">
            <div class="ms-panel">
                <div class="ms-panel-header py-2" style="display: flex; justify-content: space-between; border-bottom: 2px solid rgba(227, 149, 38) !important;">
                    <label class="invoiceInfo text-center d-block" style="margin: 0 auto;">
                        <span class="common_heading" style="width: auto!important;margin:0 auto;">
                            <span class="text-white">Business Details</span>
                        </span>
                    </label>
                </div>
                ...
                <div class="ms-panel-body">
                    <div class="main_row">
                        ...
                        <a id="create" href="<?php echo base_url('Admin/Business/business'); ?>" class="btn samplebtn waves-effect waves-light" style="font-size: 14px;color: #FFF;background-color: #ff0018; float: right;">
                            <i class="fa fa-plus-square" aria-hidden="true" style="padding-right: 7px;"></i>Add New
                        </a>
                    </div>
                            ...
                            <tbody>
                                <?php 
                                    foreach($alldata as $value) {
                                        ...
                                        echo '<td class="sorting_1"><a href="' . base_url("Admin/update_business/update/" . $value->businessId ) . '"><i class="fas fa-eye" style="font-size: 15px;"></i></a></td>';
                                        echo "<td>".$value->businessId."</td>";
                                        echo "<td>".$value->businessName."</td>";
                                        echo "</tr>";                        
                                    }
                                ?> 
                            </tbody>
...
$(document).ready(function() {
    ...
    var table = $('#businessCategory_detailview').DataTable({
        dom: 'Bfrtip',
        buttons: [
            {
                extend: 'excelHtml5',
            ...
            {
                extend: 'pdfHtml5',
                title: 'Businesscategories Report',
                exportOptions: { 
                    modifier: {
                        page: 'all' // Export all pages
                    },
