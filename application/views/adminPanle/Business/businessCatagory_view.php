        ...
        <div class="col-md-12">
          ...
          <span class="text-white">Business</span></span>
            ...
            <div class="ms-panel-body">
              ...
              <form class="needs-validation" id="Form" action="<?php echo base_url('Admin/Business/business');?>" method="post" autocomplete="off">
                <input name="businessId" id="businessId" value="" type="hidden"> 
                <div class="form-row">
                
                  <div class="col-md-4 ">
                    <label for="name">Business Name <span class="required" style="color: red">*</span></label>
                    <div class="input-group">
                      <input type="text" class="form-control form-control-sm" name="businessName" id="businessName" placeholder="Business Name" autofocus="autofocus" value="" required="">
...
function saveperform()
{
    ...
    else
    {
      ...
      var formData = new FormData(form[0]);
            ...
            $.ajax({
        url:base_path+"Admin/update_business/update",
        type: "POST",
        ...
        success: function(data) { 
           ...
           window.location.href = base_path+"Admin/Business/business";
    ...
    {      
         // alert('Insert');
        $.ajax({
              url:base_path+"Admin/Business/insertBusinessCategory",
              type: "POST",
              data: $('#Form').serialize(),
              beforeSend: function(){
              $('#btn_savee').prop('disabled', true);
