            ...
            justify-content: space-between; border-bottom: 2px solid rgba(227 149 38) !important;">
                    <label class="invoiceInfo  text-center d-block" style="margin: 0 auto;">
                        <span class="common_heading " style="width: auto!important;margin:0 auto;">
                            <span class="text-white">Employee Rule Details</span></span>
                    </label>
                ...
                <div class="ms-panel-body">
                    ...
                    <div class="table-responsive">
                                    ...
                                    <table id="business_detailview"class="table table-bordered table-striped thead-primary w-100 dataTable no-footer"
                                    role="grid" aria-describedby="business_detailview_info" style="width: 1071px;">
                                    <thead>
                                            <tr>
                                                <th>OP</th>
                                                <th>Id</th>
                                                <th>Employee Rules</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                        ...
                                        <?php 
                                            ...
                                            echo '<td class="sorting_1"><a href="' . base_url("Admin/EmpRule_update/update/" . $value->ruleId ) . '"><i class="fas fa-eye" style="font-size: 15px;"></i></a>
                                              </td>';
                                            echo "<td>".$value->ruleId ."</td>";
                                            echo "<td>".$value->EmployeeRule."</td>";
                                            echo "</tr>";                        
                                        }
                                        ?> 
...
$(document).ready(function() {
    ...
    var table = $('#business_detailview').DataTable({
        dom: 'Bfrtip',
        buttons: [
            {
                extend: 'excelHtml5',
