</style><link rel="stylesheet" type="text/css" href="https://www.adminjainbusiness.padmamanisilver.com/assets2/form.css">
...
<div class="ms-content-wrapper"> 
      <div class="row">
        <div class="col-md-12">
          ...
          <span class="text-white">Employee Rule</span></span>
          </label>
            ...
            <div class="ms-panel-body">
              ...
              <form class="needs-validation" id="Form" action="<?php echo base_url('Admin/EmployeeRule/Add'); ?>" method="post" autocomplete="off">
                <input name="ruleId" id="ruleId" value="" type="hidden"> 
                <div class="form-row">
                
                  <div class="col-md-4 ">
                    <label for="name">Rules<span class="required" style="color: red">*</span></label>
                    <div class="input-group">
                      <input type="text" class="form-control form-control-sm" name="EmployeeRule" id="EmployeeRule" autofocus="autofocus" value="" required="">
                ...
                <div style="text-align: end;">
                  ...
                  <a id="create" href="<?php echo base_url('Admin/EmpRule_detail/index'); ?>" class="Edit btn samplebtn waves-effect waves-light"><i class="fa fa-edit" aria-hidden="true"></i>Edit</a>
                </div>
    ...
    <!-- <script src="https://www.adminjainbusiness.padmamanisilver.com/web_resources/dist/js/controllers/EmpRuleCreate.js"></script> -->
    <script src="https://www.adminjainbusiness.padmamanisilver.com/assets/js/jquery-3.3.1.min.js"></script>
<!-- <script src="https://www.adminjainbusiness.padmamanisilver.com/web_resources/dist/js/controllers/keyskillCreate.js"></script> -->
<!-- <script src="<?=base_url()?>Assets/js/AdminJS/EmpRuleCreate.js"></script> -->
 <script>
