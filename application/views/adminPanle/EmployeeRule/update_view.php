            ...
            justify-content: space-between; border-bottom: 2px solid rgba(227 149 38) !important;">
                ...
                <div class="ms-panel-body">
                    ...
                    <form class="needs-validation" id="Form"
                        action="<?php echo base_url('update/'.(isset($EmpRule -> ruleId)?'updaeEmpRule':'insertEmpRule')) ?>"
                        method="post" autocomplete="off">
                        <input name="ruleId" id="ruleId" value="<?= isset($EmpRule->ruleId)? $EmpRule->ruleId: ''?> "
                            type="hidden">
                        <div class="form-row">
                            ...
                            <div class="col-md-4 ">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control form-control-sm" name="EmployeeRule"
                                        id="EmployeeRule" autofocus="autofocus"
                                        value="<?= isset($EmpRule->EmployeeRule) ? $EmpRule->EmployeeRule : '' ?>"
                                        required="">
                        ...
                        <div style="text-align: end;">
                            ...
                            <a id="create" href="<?php echo base_url('Admin/EmployeeRule/Add'); ?>"
...
function saveperform() {
    ...
    if (EmployeeRule == "") {
        ...
        if (ruleId > 0) {
            ...
            $.ajax({
                url: base_path + "Admin/EmpRule_update/updaeEmpRule",
                type: "POST",
                ...
                success: function(data) {
                    ...
                    window.location.href = base_path + "Admin/EmpRule_update/update";
